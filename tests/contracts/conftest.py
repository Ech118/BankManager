"""FROZEN (Step 0). Shared test setup for the contract tests."""
import os
import sys
...
ORIGINAL_BM_MODE = os.environ.get("BM_MODE", "mock").lower()
...
def pytest_configure(config):
    config.addinivalue_line("markers", "live: needs BM_MODE=live and real API keys")
